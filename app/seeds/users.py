...
def seed_users():
  demo = User(username='yung-demo', email='demo@user.io', password='password', image_url="")
  ...
  maxcoveri = User(username='Max Coveri', email='max.coveri@user.io', password='password', image_url="")
  ...
  user17 = User(username='nat_brown', email='natalie.brown@user.io', password='password', image_url="https://res.cloudinary.com/dzsgront4/image/upload/v1700889027/alicesmith_xmhfdy.png")
